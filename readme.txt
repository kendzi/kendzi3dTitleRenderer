...
This program is shared on licence BSDv3 more information in file BSD3.txt.
...
- run ant build
- unpack generated zip file and run file "run32.bat" or "run64.bat" depending on java version.
