 ...
 *
 */
public class Kendzi3dTitleGLEventListener implements GLEventListener {
    ...
    public void display(GLAutoDrawable pDrawable) {
        ...
        //
        setCamera(glu, this.camraCenter);
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        ...
        //        gl.glOrtho(-100, 100, -100, 100, -100, 200);
     ...
     * @param camraCenter
     */
    private void setCamera(GLU pGlu, Point2d camraCenter) {
        ...
        pGlu.gluLookAt(posLookAt.getX(), posLookAt.getY(), posLookAt.getZ(),
